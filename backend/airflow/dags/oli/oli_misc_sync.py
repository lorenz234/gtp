...
def main():
    ...
    def sync_categories_from_OLI_github():
        ...
        for row in df_new.itertuples():
            send_discord_message(f'New OLI usage_category found and synced to oli_categories table: `{row.category_id}`. Please assign a main category to this new usage_category in the database unser the table oli_categories_main!', os.getenv('DISCORD_CONTRACTS'))
