...
def etl():
    ...
    def airtable_write_label_pool_reattest():
        ...
        if df_air.empty == False:
            ...
            send_discord_message(f"Daily summary: {df_air.shape[0]} new attestations submitted to label pool for, please review in airtable.", os.getenv('DISCORD_CONTRACTS'))
